...
- [**Sitecore structure**](#sitecore-structure)
  ...
  - [7. **Layout**](#7-layout)
  - [8. **Tanent in SXA**](#8-tanent-in-sxa)
  - [9. **Site in SXA**](#9-site-in-sxa)
...
In the context of Sitecore Experience Accelerator (SXA), atenant is a top-level container for the sites underneath. SXA supports multitenancy, which means that you can run multiple sites on a single instance of Sitecore.[^4]
...
Sites are the items that represent the website and consist of pages, data, designs, and partial layouts.[^5]
